...
async def get_business_info(
    ...
    emails_list = emails_result.get('emails', [])
    if (not emails_list) and social_links.get('contact'):
    ...
    # Ensure emails_list is a list and join properly
    if isinstance(emails_list, list):
        email_str = " || ".join(emails_list)
    else:
        email_str = str(emails_list)
